...
- (void)viewDidLoad {
    ...
    self.tabParticipants= [[NSArray alloc] initWithObjects: @"John", @"Tony", @"Mike",
                  @"James", @"Fuck", nil];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return [self.tabParticipants count];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.participantLabel.text=[self.tabParticipants objectAtIndex:indexPath.row];
